    ...
    return (
        <>
            ...
            <div className='bodyforget d-flex flex-column justify-content-center align-items-center'>
                <img src="../image/logo1.png" alt="" className='m-5' height={"300px"} width={"300px"} />
                <div className='formFroget'>
                    <form className="form " onSubmit={handleSubmit}>
                        <div className="form-group">
                            <div className="mb-3">
                                <label for="exampleFormControlInput1" className="form-label py-3">Email address of your account :</label>
                                <input type="email" className="form-control" id="exampleFormControlInput1" value={email} placeholder="name@example.com" onChange={(e) => setEmail(e.target.value)} />
                            </div>
                        </div>
