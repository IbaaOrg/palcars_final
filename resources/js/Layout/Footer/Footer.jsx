                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <div class=" d-flex flex-column justify-content-center align-items-center ">
                                <img src={logo} class="navbar-brand my-3" width="200px" />
                        ...
                        <div class="col">
                            <div class="d-flex justify-content-around subdiv2">
                                ...
                                <div>
                                    ...
                                    <h6 className='my-1'><ImLinkedin size={25} className='text-black'/>
</h6>
                                    <h6 className='my-1'><FaFacebookSquare size={25} className='text-black'/>
</h6>
                                    <h6 className='my-1'><GrInstagram size={25} className='text-black'/>
</h6>
                                    <h6 className=' text-white w-50 px-2 py-1 my-2 d-flex justify-content-center rounded bg-black' >X</h6>
                                    </div>
