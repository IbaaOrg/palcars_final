...
<div className='h-50'>
        ...
        <p className='d-flex flex-column align-items-center text-slate pt-2'>Ein Sara, <span>Hebron</span> </p>
        </div>
        </div>
        <div className="d-flex flex-column cardcontact">
          <div  className='h-50'>
        ...
        <div  className='h-50'>
        <h3 className='text-center fs-4'>Phone Number</h3>
        ...
        <div  className='h-50 d-flex flex-column '><h3 className='fs-4 text_center align-self-center'>Email</h3>
