          ...
          {citys && (  
            <div className=' d-flex justify-around'>
               ...
               <div>
                  ...
                  <div>
                     <label for="exampleFormControlInput1" className=' mr-3'>Location </label>

                          <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="location..." onChange={(e)=>{setLocationname(e.target.value)}}/>
                  </div>
                         
                  </div> 
                      {showdropoff && (
                          <div>
                              <label for="select" className=' mr-3'>Drop off</label>

                              <select class="select-input m-4" id='select' onChange={setlocation2} >
                              ...
                              <div>
                                  ...
                                  <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="location..." onChange={(e) => { setLocationname2(e.target.value) }} />
                              </div>
                          </div>
                      )}
                  </div>
              ...
              <div class="form-check">
                  <input class="form-check-input" type="checkbox" id="gridCheck" onChange={toggle}/>
              ...
              <div className=' d-flex justify-end'>
                    <button className='btn btn-success' onClick={addlocation}>Save Change</button>
              </div>
          </div>
