...
<>
                ...
                <div className="container d-flex justify-center col">
                        ...
                        <map name="image-map">
                            ...
                            <area target="" alt="jinen" title="Jinen" href={`city?city=${city}`} onClick={(e)=>setCity(e.target.title)} coords="239,207,246,205,252,198,260,189,255,182,243,176,240,168,236,163,228,164,216,165,210,161,202,165,195,165,195,172,192,182,190,188,189,198,196,200,196,209,200,215,210,219,223,219,232,219" shape="poly" />
                            <area target="" alt="tulkarem" title="Tulkarem" href={`city?city=${city}`} onClick={(e)=>setCity(e.target.title)} coords="186,197,150,197,138,244,144,251,153,250,160,251,160,259,164,263,172,264,180,257,190,250,196,241,201,235,199,221,195,209,192,200" shape="poly" />
                            ...
                            <area target="" alt="nasreh" title="Nasreh" href={`city?city=${city}`} onClick={(e)=>setCity(e.target.title)} coords="238,161,228,161,216,159,208,149,202,144,207,138,212,126,216,118,216,109,220,105,225,110,229,119,236,116,243,114,244,123,247,136,250,144" shape="poly" />
                            <area target="" alt="tabrea" title="Tabrea" href={`city?city=${city}`} onClick={(e)=>setCity(e.target.title)} coords="245,115,249,121,245,127,247,136,253,144,266,146,276,149,282,153,279,143,286,141,292,134,288,128,281,133,275,127,270,116,266,109,270,103,277,99,266,94,257,95,247,94,240,98,242,103" shape="poly" />
                            ...
                            <area target="" alt="yafa" title="Yafa" href={`city?city=${city}`} onClick={(e)=>setCity(e.target.title)} coords="137,247,123,290,133,295,140,296,144,301,149,292,157,291,161,285,156,276,158,264,158,256,153,251" shape="poly" />
                            <area target="" alt="ramleh" title="Ramleh" href={`city?city=${city}`} onClick={(e)=>setCity(e.target.title)} coords="122,294,112,314,123,329,139,333,142,343,148,344,170,330,160,310,153,293,144,301,133,296" shape="poly" />
                            <area target="" alt="led" title="Led" href={`city?city=${city}`} onClick={(e)=>setCity(e.target.title)} coords="160,268,159,276,163,281,160,291,155,296,171,329,182,324,183,295,176,295,178,280,166,269" shape="poly" />
                            <area target="" alt="beralsaba" title="Beralsaba" href={`city?city=${city}`} onClick={(e)=>setCity(e.target.title)} coords="52,443,66,436,65,429,57,420,65,415,77,412,90,413,105,404,115,404,117,395,117,384,127,379,139,378,141,384,137,394,137,406,142,413,149,420,157,424,156,431,160,438,169,445,182,444,188,442,191,448,200,450,213,453,223,453,234,452,239,461,244,465,245,472,249,482,250,488,245,492,241,497,240,509,237,515,235,527,230,536,227,547,224,553,221,559,209,568,219,565,225,573,228,579,224,584,222,593,219,601,223,613,227,617,219,629,215,643,212,655,210,668,208,678,206,688,205,701,202,711,199,720,189,727,188,735,180,723,175,694,168,685,157,668,151,658,149,641,138,616,125,592,118,590,110,582,111,561,107,548,99,523,82,502,65,468,60,459,57,453,57,462,63,461,60,459" shape="poly" />
                        </map>
                    </div>
                </div>
                </div>
