...
Route::middleware('auth:sanctum','company')->post('/addEmployees',[EmployeeController::class,'store']);
Route::middleware('auth:sanctum','company')->get('/allMyEmployees',[EmployeeController::class,'EmployeesOfUser']);
Route::middleware('auth:sanctum','company')->post('/updateEmployee/{id}',[EmployeeController::class,'update']);
Route::middleware('auth:sanctum','company')->delete('/deleteEmployee/{id}',[EmployeeController::class,'destroy']);
Route::middleware('auth:sanctum','company')->get('/showEmployee/{id}',[EmployeeController::class,'show']);
Route::middleware('auth:sanctum','company')->get('/allBills/{id}',[BillController
